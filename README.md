...
** Please note the script _UserMgmt.sh_ uses the _GroupUsers.txt_ and removes the users and created thm again with groups etc assigned to them except the group adm and sudo _ **
